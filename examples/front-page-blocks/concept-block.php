	...
	<div class="row center client-carousel">
		<div class="flexslider unstyled" data-plugin-options='{"directionNav":false, "animation":"slide", "slideshow": false, "maxVisibleItems": 6}'>
			<ul class="slides">
				<li>
					<div class="span2">
						<img class="mobile-max-width small" src="<?php global $parent_root; echo $parent_root; ?>/img/logo-client-1.jpg" alt="img">
					</div>
				</li>
				<li>
					<div class="span2">
						<img class="mobile-max-width small" src="<?php global $parent_root; echo $parent_root; ?>/img/logo-client-2.jpg" alt="img">
					</div>
				</li>
				<li>
					<div class="span2">
						<img class="mobile-max-width small" src="<?php global $parent_root; echo $parent_root; ?>/img/logo-client-3.jpg" alt="img">
					</div>
				</li>
				<li>
					<div class="span2">
						<img class="mobile-max-width small" src="<?php global $parent_root; echo $parent_root; ?>/img/logo-client-4.jpg" alt="img">
					</div>
				</li>
				<li>
					<div class="span2">
						<img class="mobile-max-width small" src="<?php global $parent_root; echo $parent_root; ?>/img/logo-client-5.jpg" alt="img">
					</div>
				</li>
				<li>
					<div class="span2">
						<img class="mobile-max-width small" src="<?php global $parent_root; echo $parent_root; ?>/img/logo-client-6.jpg" alt="img">
					</div>
				</li>
				<li>
					<div class="span2">
						<img class="mobile-max-width small" src="<?php global $parent_root; echo $parent_root; ?>/img/logo-client-4.jpg" alt="">
					</div>
				</li>
				<li>
					<div class="span2">
						<img class="mobile-max-width small" src="<?php global $parent_root; echo $parent_root; ?>/img/logo-client-2.jpg" alt="">
					</div>
				</li>
			</ul>
		</div>
