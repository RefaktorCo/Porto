...
var styleSwitcher = {
	...
	initialize: function() {
		...
		// Style Switcher CSS
		$("head").append($('<link rel="stylesheet">').attr("href", "http://localhost:8888/development/porto/sites/all/themes/Porto/master/style-switcher/style-switcher.css") );
		$("head").append($('<link rel="stylesheet/less">').attr("href", "http://localhost:8888/development/porto/sites/all/themes/Porto/master/less/skin.less") );
		$("head").append($('<link rel="stylesheet">').attr("href", "http://localhost:8888/development/porto/sites/all/themes/Porto/master/style-switcher/colorpicker/css/colorpicker.css") );

		$.getScript("http://localhost:8888/development/porto/sites/all/themes/Porto/master/style-switcher/colorpicker/js/bootstrap-colorpicker.js", function(data, textStatus, jqxhr) {

			less = {
				env: "development"
			};

			$.getScript("http://localhost:8888/development/porto/sites/all/themes/Porto/master/less/less.js", function(data, textStatus, jqxhr) {
		...
		$.getScript("http://localhost:8888/development/porto/sites/all/themes/Porto/master/style-switcher/cssbeautify/cssbeautify.js", function(data, textStatus, jqxhr) {});
